export function MunJea() {
  const Munlist: string[] = [
    ...
    ".dap{ width: 200px; height: 100px; background-color: purple;}",
    ".dap{ width: 150px; height: 150px; border-radius: 50%; background-color: orange;}",
    ".dap{ width: 100px; height: 100px; transform: rotate(45deg); background-color: pink;}",
    ".dap{ width: 100px; height: 100px; background-image: linear-gradient(to right, red, yellow);}",
    ".dap{ width: 100px; height: 100px; box-shadow: 5px 5px 10px gray; background-color: cyan;}",
    ".dap{ width: 100px; height: 100px; opacity: 0.5; background-color: lime;}",
